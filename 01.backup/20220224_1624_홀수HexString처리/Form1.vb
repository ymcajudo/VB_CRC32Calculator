    ...
    Private Sub bt_CRC32_Click(sender As Object, e As EventArgs) Handles bt_CRC32.Click
        ...
        Try
            If SelectHex = True Then
                ...
                '입력된 Hex string의 Length가 홀수이면 맨 마지막 hex 값 앞에 0을 추가. 예: 12345 => 123405
                If Int(InputData.Length) Mod 2 <> 0 Then
                    InputData = InputData.Substring(0, InputData.Length - 1) & "0" & InputData.Substring(InputData.Length - 1, 1)
                End If
